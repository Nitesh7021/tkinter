...
class LoginPage:
    def __init__(self, window):
        ...
        self.signup_button_label = Button(self.lgn_frame, image=self.signup_img, bg='#040405', cursor="hand2",
    ...
    def verify_login(self):
        ...
        if username == "admin" and password == "123":  # Replace with your credentials
            self.window.destroy()
            # Execute the stopwatch.py file
            subprocess.run(['python', r'C:\Users\nitin sharma\Downloads\Nitesh Work\ppproject\demo.py'])
        else:
